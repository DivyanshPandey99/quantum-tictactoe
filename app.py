...
import numpy as np
import pandas as pd
from game import validate, get_random_value
import math
...
def main():
    ...
    if(option=="Play"):
        ...
        For eg, if user selects a piece, it's actually possible that 
        the piece take the value of |0> and not |1>.
        ...
        instruction_2 = """
        The user can select any space from the 3x3 grid using the selection menu as shown below 
